...
<div style = "border: 1px solid;margin: auto;width: 70%;padding: 10px;text-align:left;background:#DBF9FC;font-family: curier;font-size:15px">
...
var_profitability = var(profit_df$Profitability, na.rm = TRUE)
print(paste("variance of profitability is: ", var_profitability))


sd_profitability = sqrt(var_profitability)
...
<div style = "border: 1px solid;margin: auto;width: 100%;padding: 10px;text-align:left;background:#DBF9FC;font-family: curier;font-size:15px">
    ...
    1. Use the median() function to calculate the median of the 'Profitability' 
...
<div style = "border: 1px solid;margin: auto;width: 100%;padding: 10px;text-align:left;background:#DBF9FC;font-family: curier;font-size:15px">
    ...
    Use the which.max() function to find out. The output is the 
    location of the studio in the frequncy table. Use indexing to 
    extract it!
...
print("Relative Häufigkeit der Studios:")
print(round(relative_freq_studios, digit = 0))
...
<div style = "border: 1px solid;margin: auto;width: 100%;padding: 10px;text-align:left;background:#DBF9FC;font-family: curier;font-size:15px">
    ...
    1. Extract only the open profits that were <2000 from the original 
    dataset (i.e., movies).
    ...
    in the console and read the help page on the bottom-left side of your Rstudio). 
...
hist_openProf = hist(movies_Max2000$OpenProfit, 
