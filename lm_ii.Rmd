...
set.seed(123)
dat <- data.frame(
      "Alcohol.ml" = abs(round(rnorm(30, 30, 10), digit <-  0)),
      "Study.Hours" = abs(round(rnorm(30, 10, 10), digit <-  0)),
      "Test.Results" = abs(round(rnorm(30, 50, 10), digit <-  0))
)
...
text(x = cooks_dist[1:30], labels=c(1:30))
abline(h=4/100)

```
  
### Following their diagnostic measures, they deicded to eplore other statistical models before making any public conclusions. 
