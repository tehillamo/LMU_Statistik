...
We will learn to read in a dataset, create histograms, and perform correlation tests using basic R functions, avoiding the tidyverse package. Let's dive in!
