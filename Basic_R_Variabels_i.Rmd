...
3. Add the two vectors 'your_age_and_friends' and 'ones_vector' element-wise to calculate the age values of all friends for next year and save it as 'age_of_friends_next_year' to represent the age values of all friends for next year.

4. print your resulting vector. 
...
3. Print the value of the variable 'your_name' to display your name. 

4. ask R to provide you with the type of both variables. Are they the same?
...
4. save the conditions (3.1-3.3) as new variables. try to give them meaningfull names.
...
1. Create a vector called 'fruit_colors' that represents the ONLY the colors of these fruits. Note: You will need the following structure for your 'fruit_colors' vector (Factor(c(fruit_colors))):
