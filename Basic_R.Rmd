...
**Deutsch**: Oben auf der Webseite sind drei Links zum Herunterladen von R , abhängig von Ihrem Betriebssystem: Windows, Mac oder Linux. Wenn Sie zum Beispiel R auf Windows installieren möchten, klicken Sie auf den Link „Download R for Windows“.
...
**English**: Next, click the first link at the top of the new page. 
...
**German**: Klicke zuerst auf den ersten Link ganz oben auf der neuen Seite. 
...
Ähnlich verhält es sich mit einem R-Skript, das wie Ihr Kochbuch für die Datenanalyse ist. Es enthält eine Reihe von Anweisungen (Code), denen Sie folgen, um verschiedene Aufgaben und Analysen durchzuführen.
...
In RStudio ist die Konsole Ihr Arbeitsbereich, in dem Sie direkt mit R interagieren können.

Hier können Sie Befehle ausführen, mit Code experimentieren und sofortige Ergebnisse sehen, genauso wie ein Koch, der mit Zutaten und Kochutensilien arbeitet.
...
Du kannst auf Datenrahmen und Matrizen im Umgebung-Tab klicken, um sie in einem rasterähnlichen Gitter anzusehen.


#### ANALOGIE

Beim Kochen sammeln Sie Zutaten und verwenden verschiedene Küchenwerkzeuge wie Töpfe, Pfannen und Besteck.

In R besteht die Umgebung aus Variablen, Daten und Funktionen, die Sie geladen oder erstellt haben.

Hier werden Ihre "Zutaten" (Daten) und "Küchenwerkzeuge" (Funktionen) gespeichert, die Sie für Ihre Analyse verwenden.
...
Beim Kochen überprüfen Sie regelmäßig den Fortschritt des Gerichts, um zu sehen, ob es sich wie erwartet entwickelt.
...
Sie können Daten visualisieren, Diagramme erkunden und sicherstellen, dass alles wie geplant verläuft.
