...
data_2 <- data.frame(ID = 1:10,
                   ...
                   Salary_month = c(8, 7, 9, 6, 5, 8, 6, 9, 7, 6))
...
### We can see the results and learn that:
  ...
  - Gender_dummy = 1.5. 
    ...
    This is the predicted Monthly Salary  value for females participants is 6.5. + (1 * 1.5) = 8. 
  ...
  - The confidence interval for the intercept is [5.37, 7.63]. 
    ...
    which implies that, for males, the possible Monthly Salary  scores lie between 5.37 and 7.63. 
  
  - The confidence interval for the slope is [-0.28, 3.28]. 
    
    which implies that the plausible Monthly Salary  scores for females lie between -0.28 and 3.28. 
...
```
  ...
  - (intercept) = 6.25. This is the predicted Monthly Salary  value for participants with a high school degree.   
...
### The interpretation of the parameters is as follows:
  ...
  It represents the predicted salary for a participant without, who has an IQ of 0... Not really interpretable, is it?
...
• $\beta_{interaction}$: This is the difference in slope parameters between the reference and other category. 
  ...
  It reflects the difference in the "effectiveness" of IQ for male vs. female participants on Monthly Salary .
