...
## Arten von R-Objekten
    ...
    Ein Vektor ist eine grundlegende Datenstruktur in R, 
    
    die Elemente des gleichen Typs enthält. Dies kann numerisch, character, logisch usw. sein.
...
```
     ...
     1.6 Listen: Ein spezieller Typ, der verschiedene Arten von 
     
     Elementen wie Vektoren, Funktionen oder sogar andere Listen enthalten kann.
