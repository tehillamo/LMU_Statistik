...
<p style="font-family:monospace;color:blue;font-size:200%"> Vektoren</p>
...
<p style="font-family:monospace;color:blue;font-size:200%"> Data Arten in R </p>

![Data Types in R](img/data_types_R.png)
...
<p style="font-family:monospace;color:red;font-size:150%"> Character</p>
...
<p style="font-family:monospace;color:red;font-size:150%"> Logisch</p>
...
<p style="font-family:monospace;color:red;font-size:150%"> Faktor</p>
...
#### Unten sind einige grundlegende Berechnungen und Zuweisungen in R Studio. Sie können diese Code-Schnipsel in der R Studio Skript ausführen, um die Ergebnisse zu sehen.
...
Ein Vektor kann erstellt werden, indem Sie die Funktion c() verwenden, die für "combine" steht. Zum Beispiel, mein_vektor <- c(1, 2, 3, 4, 5) erstellt einen Vektor namens mein_vektor, der die Zahlen 1 bis 5 enthält.

Vektoren sind besonders nützlich, wenn Sie mit einer Gruppe von Datenpunkten arbeiten möchten, da sie es ermöglichen, Operationen auf alle Elemente des Vektors gleichzeitig anzuwenden. Sie können auch auf einzelne Elemente eines Vektors zugreifen, indem Sie ihren Index verwenden, wobei der Index des ersten Elements 1 ist
