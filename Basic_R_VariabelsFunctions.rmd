...
<div style = "border: 1px solid;margin: auto;width: 90%;padding: 10px;text-align:left;background:#DBF9FC;font-family: curier;font-size:12px">
Aufgabe: 
...
4. Gib die Nachricht aus, die dein aktuelles und zukünftiges Alter enthält. Verwende dazu den print() Befehl und die entsprechenden Variablen.
...
4. Gib den Vektor freunde_alter_naechstes_jahr aus, um die Alterswerte aller Freunde im nächsten Jahr darzustellen. 
...
4. Verwende die Funktion typeof() (wie im gegebenen Code) und gib den Datentyp der Variable produkt_der_alter aus, um zu überprüfen, welcher numerische Typ es ist. 
</div>
...
1. Verwende die folgende Liste von Früchten: Apfel, Banane, Erdbeere, Trauben, Orange, Kirsche, Himbeere, Pflaume, Mango, Zitrone

2. Erstelle einen Vektor namens 'frucht_farben', der die Farben dieser Früchte repräsentiert. 
...
3. Gib den erstellten Vektor 'frucht_farben' aus.
...
Berechne den Durchschnitt dieser Noten und gib ihn aus. 
