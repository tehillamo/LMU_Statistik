...
Beispiel 2: Kombinieren mehrerer Bedingungen
Du kannst auch mehrere Bedingungen mithilfe von logischen Operatoren wie & (UND) und | (ODER) kombinieren. Zum Beispiel, wenn du Zeilen filtern möchtest, in denen 'Age' größer als 25 und 'Score' kleiner als 90 ist:


```{r}
# Create logical conditions
condition_age = my_dataframe$Age > 25
condition_score = my_dataframe$Score < 90

# Combine conditions using &
combined_condition = condition_age & condition_score

# Use the combined condition to filter rows
filtered_dataframe = my_dataframe[combined_condition, ]
...
1. Add a new column named 'Salary' to the my_dataframe data frame with these salary values: 35000, 40000, 28000.
