...
```{r}
abweichungen_x = x - mean_x
abweichungen_y = y - mean_y
```

4. Korrelation berechnen

```{r}
sum_abweichung = sum((abweichungen_x)*(abweichungen_y))
cor_manu = sum_abweichung/(sd(x) * sd(y))
cor_manu  = cor_manu / length(x)
